...
public class CommentsActivity extends AppCompatActivity {
    ...
    private CommentsRecycleAdapter commentsRecycleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentsRecycleAdapter = new CommentsRecycleAdapter(commentsList);
        comment_list.setHasFixedSize(true);
        comment_list.setLayoutManager(new LinearLayoutManager(this));
        comment_list.setAdapter(commentsRecycleAdapter);
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment_message.isEmpty()){
                    ...
                    commentsMap.put("timesamp", FieldValue.serverTimestamp());
